...
<div class="menu"><a href="<?php print base_path();?>"><img src="<?php print($path_to_theme); ?>/images/home.jpg" alt="home" />
<a href="<?php print base_path(); ?>node/team"><img src="<?php print($path_to_theme); ?>/images/team.jpg" alt="team" /></a><a href="<?php print base_path(); ?>node/8"><img src="<?php print($path_to_theme); ?>/images/contact_us.jpg" alt="contact us" /></a></div>
<?php 
...
<div class="cholder">
<div class="center">
<div style="margin-left: 30px;" class="column1"><img width="93" height="21"  src="<?php print($path_to_theme); ?>/images/leadership.gif" alt="leadership"><br>
    <br />
<?php print($leadership_block['content']); ?>

</div>
<div class="column1"><img alt="personal committment" src="<?php print($path_to_theme); ?>/images/pc.gif"><br>
  <br/>
<?php print($commitment_block['content']); ?>
</div>
<div class="column1"><img width="157" height="21" alt="depth of expertise" src="<?php print($path_to_theme); ?>/images/depth.gif"><br>
  <br>
